...
>
> - **Stable version lives elsewhere** → [`Noob-stupid/dsh-plugin-hub`](https://github.com/Noob-stupid/dsh-plugin-hub) (`main` = monolith) · npm [`@noob-stupid/dsh-plugin-console@0.3.63`](https://www.npmjs.com/package/@noob-stupid/dsh-plugin-console)
